...
#define FILE_NAME  "projectlms.bin"
...
void headMessage()
{
    ...
    system("color 1");
    printf("\n\t\t\t\t\t\t   ----------------------------------------------------------------------------\n");
    printf("\n\t\t\t\t\t\t\t\t   A PROJECT OF LIBRARY MANAGEMENT SYSTEM    \n");
    printf("\n\t\t\t\t\t\t\t\t               USING C PROGRAMMING    \n");
    printf("\n\t\t\t\t\t\t   ----------------------------------------------------------------------------\n");
...
void login()
{
    ...
    headMessage();
    printf("\n\n\n\n\n\t\t\t\t\t\t\t\t\t\t\tLOGIN PAGE\n");
    printf("\n\n\t\t\tFor continue Enter username and password\n");
    fp = fopen(FILE_NAME,"rb");
    if(fp == NULL)
    {
        printf("File is not opened\n");
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="rahulgarg\n";
    const char defaultPassword[] ="rahulgarg\n";
    sFileHeader fileHeaderInfo = {0};
